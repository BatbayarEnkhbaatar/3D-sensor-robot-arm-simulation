...
def load_check_points():
  ...
  policy = RT1Policy(
      checkpoint_path = 'rt1_jax/rt_1_x_jax/b321733791_75882326_000900000/',
      model=rt1x_model,
...
class RT1Policy:
  ...
  def __init__(
    ...
    if variables:
      ...
      state_dict = checkpoints.restore_checkpoint('rt_1_x_jax/b321733791_75882326_000900000/', None)
      variables = {
...
def main(policy, embed, obvers, inputText, sequence_length=15):
  try:
    ...
    frame_list = []
    for frame in obvers:
      frame_list.append(Image.open(frame))
      
    image_obs =[]
    for indx in range(sequence_length):
      image_obs.append(frame_list[indx])
