...
{
  const double* joint_values = robot_state.getJointPositions("joint_t");
  return (joint_values[0] > 0.0);
}
// END_SUB_TUTORIAL

static const rclcpp::Logger LOGGER = rclcpp::get_logger("planning_scene");
...
int main(int argc, char** argv)
{
  ...
  auto planning_scene_tutorial_node = rclcpp::Node::make_shared("planning_scene", node_options);
