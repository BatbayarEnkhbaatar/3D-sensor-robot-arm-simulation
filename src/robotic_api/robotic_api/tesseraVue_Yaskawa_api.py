...
class HandEyeCalib(Node):
    ...
    def compute_and_publish_xyzrpy(self, target_point_msg):
        ...
        # adjusting pose to grasp
        # end_ef_pose1 = [533.792, 16.682, 387.559, 168.8965, 7.5397, 100.5778]
        # msg = xyzrpy_msgs()
        # msg.xyzrpy = end_ef_pose1
        # self.xyzrpy_publisher.publish(msg)
        # self.get_logger().info(f"Adjusting the Robot Pose: {msg.xyzrpy}")
        # time.sleep(3)
    
        # rpy = [179.9388, -5.2135, -66.4966]
