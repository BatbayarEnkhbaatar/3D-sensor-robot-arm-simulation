...
: ${AMENT_CURRENT_PREFIX:="/home/ubuntu/robot-simulation/src/install/yaskawa_mh5_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/yaskawa_mh5_controller/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/yaskawa_mh5_controller/environment/path.sh"
